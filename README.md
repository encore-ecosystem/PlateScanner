...
Проект **PlateScanner** предоставляет пользователям специализированную валидацию. Подробнее о ней вы можете ознакомиться, перейдя по следующей ссылке: **[Новые подходы к валидации нейронных сетей в задаче детекции ГРЗ](.\articles\Art1.md)**.
